...
- **descoberta:** a varredura passa a dizer **que aparelho é** cada endereço, não só de que marca. A coluna "Fabricante" dá lugar a **"Equipamento"**, que mostra o modelo quando se sabe e o fabricante quando é tudo o que há. O modelo vem de três sítios, por ordem de confiança: do **registo do ISPM** (o equipamento que já foi registado por alguém que o teve na mão), dos **vizinhos do router de gestão** (quem se anuncia por MNDP/CDP/LLDP), e de **perguntar ao próprio equipamento** por SNMP ou pela interface web. Por baixo do modelo fica escrito de onde veio
- **descoberta:** quando o modelo registado **não bate certo** com o que o equipamento responde na rede, a linha fica a laranja. Quase sempre quer dizer que o aparelho foi trocado no terreno e ninguém atualizou o sistema
