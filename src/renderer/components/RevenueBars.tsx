...
/**
 * Source of truth: Dashboard revenue chart. Renders paid/pending revenue bars with
 * investimentos (expense) and despesas (opex) overlay lines; the hover tooltip computes
